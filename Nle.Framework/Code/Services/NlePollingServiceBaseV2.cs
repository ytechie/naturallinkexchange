...
namespace Nle.Services
{
	...
	/// </summary>
    /// <remarks>
    ///     Todo: If the service configuration data is reloaded, we need to adjust the
    ///             polling timer to be correct.
    /// </remarks>
	public abstract class NlePollingServiceBaseV2 : ServiceBase
	{
        ...
        public NlePollingServiceBaseV2() : base()
        {
            initLogging();
        }
