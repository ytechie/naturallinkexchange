...
Select dbo.[Sites_IsSiteFullyConfigured](30)
...
Select dbo.Sites_HasValidSubscription(30)
Select dbo.Sites_HasPublishedArticles(30)
Select dbo.Sites_HasLinkPageSetup(30)

Select Name, dbo.[Sites_IsSiteFullyConfigured](s.Id)
From Sites s

select count(*) from sites where dbo.Sites_HasLinkPageSetup(id) = 1
select count(*) from sites where dbo.Sites_IsSiteFullyConfigured(id) = 1
